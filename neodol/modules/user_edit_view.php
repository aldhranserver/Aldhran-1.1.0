<?php
/**
 * USER EDIT VIEW - NeoDOL Standalone
 * Version: 2.1.0 - PDO & NO DOL BRIDGE
 */
...
if ($target_id === 0) {
    die("<div style='color:orange; padding:20px;'>Fehler: Keine User-ID in der URL gefunden.</div>");
}

// Umstellung auf PDO für Standalone Sicherheit
