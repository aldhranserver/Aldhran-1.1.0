<aside class="sidebar">
    <nav>
        ...
        <ul>
            ...
            <li><a href="?p=participation"><i class="fas fa-users-cog"></i> Take part</a></li>
        </ul>
        ...
        <h3><i class="fas fa-book-open"></i> Hub</h3>
        <ul>
            <li><a href="https://github.com/Dawn-of-Light/DOLSharp"><i class="fas fa-dragon"></i> DOL on GitHub</a></li>
            <li><a href="?p=downloads"><i class="fas fa-khanda"></i> Downloads</a></li>
            <li><a href="https://aldhran-server.eu/daocportalnr/"><i class="fas fa-map-marked-alt"></i> DAoC Portal NR</a></li>
            <li><a href="https://dolserver.sourceforge.net/"><i class="fas fa-fist-raised"></i> DOL Website</a></li>
        </ul>
        ...
        if ($canAdmin): ?>
            ...
            <ul>
                ...
                <?php if ($checkPriv >= 4): ?>
                    <li><a href="?p=spike_admin" class="admin-link"><i class="fas fa-comments"></i> Spike ACP</a></li>
