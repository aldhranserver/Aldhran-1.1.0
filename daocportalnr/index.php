 ...
 * Version: 2.1.0 - Target: server_display.php
 */
...
<head>
    ...
    <style>
        ...
        .nav-btn:hover { border-color: #c5a059; color: #c5a059; }
...
<div class="portal-wrapper">
    ...
    <div class="launcher-notice <?php echo $launcher_ready ? 'launcher-ready' : 'launcher-missing'; ?>">
        ...
        <?php else: ?>
            <i class="fas fa-times"></i> LAUNCHER MISSING - <a href="DOWNLOADS/launcher.zip" style="color:#c5a059">DOWNLOAD OR RUN IT</a>
        <?php endif; ?>
    </div>
        ...
        <div class="server-row">
            ...
            <div style="text-align: center;">
                <?php if($launcher_ready && $is_online): ?>
                    <a href="javascript:void(0)" onclick="launch('<?php echo $srv['server_ip']; ?>', '<?php echo $srv['server_port']; ?>')" class="btn-nexus btn-connect">CONNECT</a>
                <?php else: ?>
...
function launch(ip, port) {
    ...
    if(!user || !pass) { alert("Please enter Account and Password."); return; }
    window.location.href = "daocnr://" + ip + ":" + port + "/" + encodeURIComponent(user) + "/" + encodeURIComponent(pass);
}
</script>
