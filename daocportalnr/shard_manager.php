 ...
 * Version: 1.2.0 - Independent Portal User System
 */
require_once('../includes/db.php');
if (session_status() === PHP_SESSION_NONE) { session_start(); }

// Check for Portal-specific Login
...
// Logic: Delete Shard (Only if owned by current portal user)
if (isset($_GET['del'])) {
    $delId = (int)$_GET['del'];
...
// Fetch all Shards owned by this account
...
<head>
    ...
    <style>
        ...
        .manager-window { max-width: 900px; margin: 0 auto; background: #0a0a0a; border: 1px solid #222; border-top: 2px solid #c5a059; padding: 30px; box-shadow: 0 0 30px rgba(0,0,0,0.8); }
...
<div class="manager-window">
    ...
    <table class="shard-table">
        ...
        <tbody>
            <?php if (empty($shards)): ?>
                <tr>
                    <td colspan="4" style="text-align: center; color: #333; padding: 40px; font-style: italic;">
                        No shards registered under this account.
                    </td>
                </tr>
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        ...
                        <a href="?del=<?php echo $s['id']; ?>" class="delete-link" onclick="return confirm('Eradicate this shard from the portal?')"><i class="fas fa-trash-alt"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
...
<div style="text-align: center; margin-top: 30px;">
    <a href="portal_logout.php" style="color: #444; font-size: 10px; text-decoration: none; font-family: 'Cinzel'; letter-spacing: 2px;">Logout Session</a>
</div>
