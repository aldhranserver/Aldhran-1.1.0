 ...
 * Version: 2.1.15 - SECURITY: CSRF Token Bridge | NO UI CHANGES
 */
...
// Wir generieren den Token für die AJAX-Speicherung
        ...
        <div style="display: flex; gap: 10px;">
            ...
            <button type="button" 
                onclick="if(confirm('ACHTUNG: Soll der User <?php echo addslashes($u_data['username']); ?> wirklich unwiderruflich gelöscht werden?')){ 
                    ...
                    fd.append('csrf_token', '<?php echo $view_token; ?>'); // Token hinzugefügt
